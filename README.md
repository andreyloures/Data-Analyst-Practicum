...
| 13  |[Выпускной проект](big_cities_music) | анализируем товарный ассортимент интернет-магазина, делаем задания по A/B-тестированию и SQL.|*pandas*, *numpy*, *datetime*, *plotly*, *seaborn*, *math*, *matplotlib*, *sklearn*, *scipy*|
